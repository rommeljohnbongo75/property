...
<style>
    ...
    body {
        ...
        .toatal-amount-one h4,
        .toatal-amount-one h5 {
            color: black;
            font-weight: bold;
        }
   ...
   margin-top:20px;
    ...
    Slide in animation @-moz-keyframes slidein {
        0% {
            left: -200px;
        }
                ...
                <div class="col-sm-12 col-lg-6">
                    <div class="qutoes-form ">
                        ...
                        <div class="booking-status d-flex justify-content-between">
                            <h4>Status</h4>
                            <h5 class="position-relative"><a href="">Pending For Owner<i
